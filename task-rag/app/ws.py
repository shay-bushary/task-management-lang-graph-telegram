...
class WebSocketManager:
    ...
    async def broadcast_token(self, session_id: str, token: str):
        ...
        await self.send_message(
            session_id, {"type": "token", "content": token, "session_id": session_id}
        )
    ...
    async def broadcast_event(self, session_id: str, event_type: str, data: Any = None):
        ...
        """
        message = {"type": "event", "event_type": event_type, "session_id": session_id}
    ...
    async def broadcast_final_result(self, session_id: str, result: Any):
        ...
        await self.send_message(
            session_id,
            {"type": "final_result", "result": result, "session_id": session_id},
        )
    ...
    async def broadcast_error(self, session_id: str, error: str):
        ...
        """
        await self.send_message(
            session_id, {"type": "error", "error": error, "session_id": session_id}
        )

    async def prepare_session(
        self, session_id: str, initial_state: Dict[str, Any], graph: CompiledGraph
    ):
        ...
        try:
            ...
            if final_state:
                ...
                if final_messages:
                    ...
                    await self.broadcast_final_result(
                        session_id,
                        {
