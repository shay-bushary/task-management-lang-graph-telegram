...
def create_app() -> FastAPI:
    ...
    async def log_requests(request: Request, call_next):
        ...
        start_time = logger.handlers[0].formatter.formatTime(
        ...
        try:
            ...
            health_status = {
                ...
                "services": {
                    ...
                    "task_service": "initialized" if task_service else "not_initialized"
                },
                "directories": {
            ...
            if not rag_service or not task_service or not uploads_exists or not chroma_exists:
